          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }}>
              <Field label="Adoption Challenge">
                <select value={csData.adoption_challenge} onChange={e => setCsData(p => ({ ...p, adoption_challenge: e.target.value }))} onFocus={focus} onBlur={blur} style={inputStyle}>
              ...
              <Field label="Support Frequency">
                <select value={csData.support_contact_frequency} onChange={e => setCsData(p => ({ ...p, support_contact_frequency: e.target.value }))} onFocus={focus} onBlur={blur} style={inputStyle}>
